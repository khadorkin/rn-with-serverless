...
/* App's border settings. Use it anywhere you need the default app
border. */
const appBorder = css`
  border-width: 1px;
...
export const InputBorderContainer = styled(Row)`
  ${appBorder} position: relative;
  align-items: center;
  height: 70px;
  padding: 10px;
`;
...
export const SmallRegText = styled(RegularText)`
  font-size: 12px;
`;
